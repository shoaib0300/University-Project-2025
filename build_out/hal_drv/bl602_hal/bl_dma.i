# 1 "/home/shoaib/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c"
# 1 "/home/shoaib/bl_iot_sdk/customer_app/sdk_app_helloworld/build_out/hal_drv//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/shoaib/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c"
# 30 "/home/shoaib/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c"
...
# 31 "/home/shoaib/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c" 2
...
# 32 "/home/shoaib/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c" 2
...
# 33 "/home/shoaib/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c" 2
...
# 34 "/home/shoaib/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c" 2
...
# 36 "/home/shoaib/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c" 2
...
# 37 "/home/shoaib/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c" 2
...
# 39 "/home/shoaib/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c" 2
...
# 40 "/home/shoaib/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c" 2
...
# 42 "/home/shoaib/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c" 2
# 54 "/home/shoaib/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c"
struct dma_ctx {
...
void bl_dma_IRQHandler(void)
{
    ...
    if (
# 156 "/home/shoaib/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c" 3 4
       ((void *)0) 
# 156 "/home/shoaib/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c"
            == first) {
        ;
        while (1) {
        }
...
void *bl_dma_mem_malloc(uint32_t size)
{
    ...
    if (p_heap_addr == 
# 185 "/home/shoaib/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c" 3 4
                      ((void *)0)
# 185 "/home/shoaib/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c"
                          ) {
        return 
# 186 "/home/shoaib/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c" 3 4
              ((void *)0)
# 186 "/home/shoaib/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c"
                  ;
    }

    ptr = 
# 189 "/home/shoaib/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c" 3 4
         ((void *)0)
# 189 "/home/shoaib/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c"
             ;
    counts = 0;
    while (1) {
        ...
        if (ptr == 
# 194 "/home/shoaib/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c" 3 4
                  ((void *)0)
# 194 "/home/shoaib/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c"
                      ) {
            goto __exit;
        }
...
static void bl_dma_int_process(void)
{
    ...
    void (*handler)(void) = 
# 229 "/home/shoaib/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c" 3 4
                           ((void *)0)
# 229 "/home/shoaib/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c"
                               ;
    ...
    for (ch = 0; ch < DMA_CH_MAX; ch++) {
        ...
        if((tc_flag != 0) || (interr_flag != 0)) {
            ...
            for (node = ((struct dma_node *) ((char *) ((pstctx->pstqueue)->next) - ((size_t)&(((struct dma_node *)0)->dlist_item)))); &node->dlist_item != (pstctx->pstqueue); node = ((struct dma_node *) ((char *) (node->dlist_item.next) - ((size_t)&(((struct dma_node *)0)->dlist_item))))) {
                if (ch == node->channel) {
                    if (node->tc_handler != 
# 260 "/home/shoaib/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c" 3 4
                                           ((void *)0) 
# 260 "/home/shoaib/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c"
                                                && tc_flag != 0) {
...
# 265 "/home/shoaib/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c" 3 4
                                               ((void *)0) 
# 265 "/home/shoaib/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c"
                                                    && interr_flag != 0) {
...
# 283 "/home/shoaib/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c" 3 4
                                                              ((void *)0)
# 283 "/home/shoaib/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c"
                                                                  ) {
        ;
    ...
    if (pstnode == 
# 297 "/home/shoaib/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c" 3 4
                  ((void *)0)
# 297 "/home/shoaib/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c"
                      ) {
        ;
    }
...
void *bl_dma_find_node_by_channel(int channel)
{
    ...
    if (&(node->dlist_item) == pstctx->pstqueue) {
        ...
        return 
# 324 "/home/shoaib/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c" 3 4
              ((void *)0)
# 324 "/home/shoaib/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c"
                  ;
    }
...
void bl_dma_init(void)
{
    ...
    if (pstctx == 
# 383 "/home/shoaib/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c" 3 4
                 ((void *)0)
# 383 "/home/shoaib/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c"
                     ) {
        ;
    ...
    if (pstctx->pstqueue == 
# 390 "/home/shoaib/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c" 3 4
                           ((void *)0)
# 390 "/home/shoaib/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c"
                               ) {
        ;
...
# 403 "/home/shoaib/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c" 3 4
                                                                    ((void *)0)
# 403 "/home/shoaib/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c"
                                                                        , 
# 403 "/home/shoaib/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c" 3 4
                                                                          ((void *)0)
# 403 "/home/shoaib/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c"
...
static void _cb_cmd(void *arg)
{
    ...
    ;
    first->arg = 
# 413 "/home/shoaib/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c" 3 4
                ((void *)0)
# 413 "/home/shoaib/bl_iot_sdk/components/hal_drv/bl602_hal/bl_dma.c"
                    ;
}
