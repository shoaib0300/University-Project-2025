...
LED_Blink:
.LFB16:
	.loc 2 48 48 is_stmt 1
	.cfi_startproc
.LVL60:
	.loc 2 49 5
	.loc 2 48 48 is_stmt 0
	addi	sp,sp,-16
	.cfi_def_cfa_offset 16
	sw	s0,8(sp)
	.cfi_offset 8, -8
...
Clap_Detected:
.LFB17:
	.loc 2 56 25 is_stmt 1
	.cfi_startproc
	.loc 2 57 5
	.loc 2 58 5
	.loc 2 56 25 is_stmt 0
	addi	sp,sp,-16
	.cfi_def_cfa_offset 16
	.loc 2 58 22
	li	a0,12
...
Task_TempHumidity:
.LFB18:
	.loc 2 70 30 is_stmt 1
	.cfi_startproc
	.loc 2 71 5
	.loc 2 70 30 is_stmt 0
	addi	sp,sp,-64
...
.L44:
	...
	addi	a0,s1,%lo(DHT11_Data)
	call	DHT_GetData
.LVL74:
	.loc 2 76 9
	.loc 2 76 23 is_stmt 0
	addi	a5,s1,%lo(DHT11_Data)
	flw	fs0,0(a5)
	.loc 2 76 12
	fmv.s.x	fa5,zero
	feq.s	a4,fs0,fa5
	bne	a4,zero,.L37
	.loc 2 76 49 discriminator 1
	flw	fa0,4(a5)
	.loc 2 76 36 discriminator 1
	feq.s	a5,fa0,fa5
	bne	a5,zero,.L37
	.loc 2 77 13 is_stmt 1
	.loc 2 78 22 is_stmt 0
...
.LVL84:
	call	bl_timer_delay_us
.LVL85:
	.loc 2 74 5 is_stmt 0 discriminator 2
	bne	s0,zero,.L44
.LBE51:
	.loc 2 99 1
	lw	ra,60(sp)
...
.LVL91:
.L54:
	.loc 2 109 9 discriminator 2
	mv	a0,s1
	addi	s0,s0,-1
.LVL92:
	call	bl_timer_delay_us
.LVL93:
	.loc 2 104 5 is_stmt 0 discriminator 2
	bne	s0,zero,.L55
.LBE54:
	.loc 2 111 1
	lw	ra,12(sp)
...
bfl_main:
.LFB20:
	.loc 2 113 20 is_stmt 1
	.cfi_startproc
	.loc 2 115 5
	li	a5,1998848
	.loc 2 113 20 is_stmt 0
	addi	sp,sp,-16
	.cfi_def_cfa_offset 16
	.loc 2 115 5
	addi	a5,a5,1152
...
.LBE56:
.LBE55:
	.loc 2 121 5 is_stmt 1 discriminator 1
	.loc 2 122 9 discriminator 1
	call	Task_TempHumidity
.LVL97:
	.loc 2 123 9 discriminator 1
