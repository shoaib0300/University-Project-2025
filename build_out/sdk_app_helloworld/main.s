...
.LVL2:
	...
	.loc 1 51 3
	lui	a6,%hi(.LANCHOR1)
	lui	a5,%hi(led_stack.3340)
	lui	a1,%hi(.LC1)
	lui	a0,%hi(task_led)
	addi	a6,a6,%lo(.LANCHOR1)
	addi	a5,a5,%lo(led_stack.3340)
	li	a4,15
	li	a3,0
	li	a2,512
	addi	a1,a1,%lo(.LC1)
...
.LFE9:
	...
	.section	.bss.led_stack.3340,"aw",@nobits
	.align	2
	.type	led_stack.3340, @object
	.size	led_stack.3340, 2048
led_stack.3340:
	.zero	2048
	.section	.bss.led_task.3341,"aw",@nobits
	.align	2
	.set	.LANCHOR1,. + 0
	.type	led_task.3341, @object
	.size	led_task.3341, 96
led_task.3341:
	.zero	96
...
.Letext0:
	...
	.file 5 "/home/shoaib/bl_iot_sdk/components/bl602/freertos_riscv_ram/config/portable.h"
	.file 6 "/home/shoaib/bl_iot_sdk/components/bl602/freertos_riscv_ram/config/FreeRTOS.h"
	...
	.file 14 "/home/shoaib/bl_iot_sdk/components/bl602/freertos_riscv_ram/config/task.h"
