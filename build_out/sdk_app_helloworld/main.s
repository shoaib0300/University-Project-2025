...
.LVL52:
	.cfi_endproc
.LFE14:
	.size	GPIO_SetState, .-GPIO_SetState
...
LED_Blink:
.LFB16:
	.loc 2 50 48 is_stmt 1
	.cfi_startproc
.LVL60:
	.loc 2 51 5
	.loc 2 50 48 is_stmt 0
	addi	sp,sp,-16
	.cfi_def_cfa_offset 16
	sw	s0,8(sp)
	.cfi_offset 8, -8
...
Task_TempHumidity:
.LFB18:
	.loc 2 72 30 is_stmt 1
	.cfi_startproc
	.loc 2 73 5
	.loc 2 72 30 is_stmt 0
	addi	sp,sp,-64
...
.LVL74:
	...
	addi	s0,s0,%lo(DHT11_Data)
	flw	fs0,0(s0)
	.loc 2 78 12
	fmv.s.x	fa5,zero
	feq.s	a5,fs0,fa5
	bne	a5,zero,.L37
	.loc 2 78 49 discriminator 1
	flw	fa0,4(s0)
	.loc 2 78 36 discriminator 1
	feq.s	a5,fa0,fa5
	bne	a5,zero,.L37
...
.LVL77:
	.loc 2 83 13
	.loc 2 83 29 is_stmt 0
	flw	fa5,%lo(Temperature)(s2)
	.loc 2 83 16
	fgt.s	a5,fa5,fs1
	bne	a5,zero,.L38
	.loc 2 83 34 discriminator 1
	flt.s	a5,fa5,fs4
.LBB43:
.LBB44:
	.loc 2 34 5 discriminator 1
	li	a1,0
.LBE44:
.LBE43:
	.loc 2 83 34 discriminator 1
...
.LBE48:
	.loc 2 90 13
	.loc 2 90 26 is_stmt 0
	flw	fa5,%lo(Humidity)(s0)
	.loc 2 90 16
	fgt.s	a5,fa5,fs2
	bne	a5,zero,.L42
	.loc 2 90 31 discriminator 1
	flt.s	a5,fa5,fs3
.LBB49:
.LBB50:
	.loc 2 34 5 discriminator 1
...
.LVL84:
	call	bl_timer_delay_us
.LVL85:
	.loc 2 76 5 is_stmt 0 discriminator 2
	bne	s1,zero,.L46
.LBE55:
	.loc 2 101 1
	lw	ra,60(sp)
...
.LVL90:
	.loc 2 108 12
	beq	a0,zero,.L54
	.loc 2 109 13 is_stmt 1
	addi	a0,s2,%lo(.LC9)
	call	printf
.LVL91:
.L54:
	.loc 2 111 9 discriminator 2
	mv	a0,s1
	addi	s0,s0,-1
.LVL92:
	call	bl_timer_delay_us
.LVL93:
	.loc 2 106 5 is_stmt 0 discriminator 2
	bne	s0,zero,.L55
.LBE58:
	.loc 2 113 1
	lw	ra,12(sp)
...
.LBE60:
.LBE59:
	.loc 2 123 5 is_stmt 1 discriminator 1
	.loc 2 124 9 discriminator 1
	call	Task_TempHumidity
.LVL97:
	.loc 2 125 9 discriminator 1
...
led_clap_state:
	.zero	1
	.section	.sbss.prev_state.3912,"aw",@nobits
	.align	2
	.set	.LANCHOR0,. + 0
	.type	prev_state.3912, @object
	.size	prev_state.3912, 4
prev_state.3912:
	.zero	4
	.text
.Letext0:
	...
	.file 15 "/home/shoaib/bl_iot_sdk/components/hal_drv/bl602_hal/bl_timer.h"
	.file 16 "/home/shoaib/bl_iot_sdk/components/hal_drv/bl602_hal/bl_gpio.h"
