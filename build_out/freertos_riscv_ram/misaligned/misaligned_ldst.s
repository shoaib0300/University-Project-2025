...
truly_illegal_insn:
.LFB14:
	.file 1 "/home/shoaib/bl_iot_sdk/components/bl602/freertos_riscv_ram/misaligned/misaligned_ldst.c"
	.loc 1 29 1
	.cfi_startproc
.LVL0:
	.loc 1 30 5
 #APP
# 30 "/home/shoaib/bl_iot_sdk/components/bl602/freertos_riscv_ram/misaligned/misaligned_ldst.c" 1
	ebreak
# 0 "" 2
 #NO_APP
.L2:
...
.LBB44:
.LBB45:
	.file 2 "/home/shoaib/bl_iot_sdk/components/bl602/freertos_riscv_ram/misaligned/unprivileged_memory.h"
...
.LVL2:
	...
	li	a4,3
 #APP
# 83 "/home/shoaib/bl_iot_sdk/components/bl602/freertos_riscv_ram/misaligned/unprivileged_memory.h" 1
	csrrs a3, mstatus, a1
and a6, a2, 2
bnez a6, 1f
lw a5, (a2)
...
.LBB54:
	...
	.loc 1 40 44
 #APP
# 40 "/home/shoaib/bl_iot_sdk/components/bl602/freertos_riscv_ram/misaligned/misaligned_ldst.c" 1
	csrr t5, mbadaddr
# 0 "" 2
.LVL7:
	.loc 1 40 97
...
.L9:
 ...
 #APP
# 91 "/home/shoaib/bl_iot_sdk/components/bl602/freertos_riscv_ram/misaligned/misaligned_ldst.c" 1
	csrw mcause, 5
# 0 "" 2
...
.LVL18:
 #APP
# 39 "/home/shoaib/bl_iot_sdk/components/bl602/freertos_riscv_ram/misaligned/unprivileged_memory.h" 1
	csrrs a3, mstatus, a1
lbu t0, -1(a5)
csrw mstatus, a3
# 0 "" 2
...
.LVL43:
 ...
 #APP
# 167 "/home/shoaib/bl_iot_sdk/components/bl602/freertos_riscv_ram/misaligned/misaligned_ldst.c" 1
	csrw mcause, 7
# 0 "" 2
...
.LBB79:
	.loc 1 135 149
 #APP
# 135 "/home/shoaib/bl_iot_sdk/components/bl602/freertos_riscv_ram/misaligned/misaligned_ldst.c" 1
...
.LBB80:
	...
	.loc 1 171 44
 #APP
# 171 "/home/shoaib/bl_iot_sdk/components/bl602/freertos_riscv_ram/misaligned/misaligned_ldst.c" 1
	csrr a7, mbadaddr
# 0 "" 2
.LVL49:
	.loc 1 171 97
...
.LBB83:
 ...
 #APP
# 44 "/home/shoaib/bl_iot_sdk/components/bl602/freertos_riscv_ram/misaligned/unprivileged_memory.h" 1
	csrrs a3, mstatus, a1
sb a0, 0(a6)
csrw mstatus, a3
# 0 "" 2
...
.LBB88:
	.loc 1 159 222
 #APP
# 159 "/home/shoaib/bl_iot_sdk/components/bl602/freertos_riscv_ram/misaligned/misaligned_ldst.c" 1
	1: auipc a5, %pcrel_hi(get_f32_reg); add a5, a5, a0; jalr t0, a5, %pcrel_lo(1b)
# 0 "" 2
.LVL61:
...
.LBB91:
	.loc 1 161 146
 #APP
# 161 "/home/shoaib/bl_iot_sdk/components/bl602/freertos_riscv_ram/misaligned/misaligned_ldst.c" 1
	1: auipc a5, %pcrel_hi(get_f32_reg); add a5, a5, a0; jalr t0, a5, %pcrel_lo(1b)
# 0 "" 2
.LVL67:
...
.Letext0:
	...
	.file 4 "/home/shoaib/bl_iot_sdk/components/bl602/freertos_riscv_ram/misaligned/emulation.h"
...
.LASF16:
	.string	"intx"
.LASF38:
	.string	"/home/shoaib/bl_iot_sdk/components/bl602/freertos_riscv_ram/misaligned/misaligned_ldst.c"
.LASF13:
	.string	"uintptr_t"
.LASF34:
	.string	"__mstatus"
